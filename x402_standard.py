...
SERVER_NAME = 'Currency & Exchange Rate MCP'
SERVER_DESC = 'Cross-border payment cost calculator — total landed cost including FX spread, transfer fees, and settlement time by payment method. Also provides real-time exchange rates and currency conversion.'

# (tool, price-const-in-config | None, literal-fallback, human description)
_PAID = [
    ["brief_summary", "PRICE_BRIEF_SUMMARY", 0.5, "Brief summary — top 5 signals (sample of daily_brief)"],['historical_rate', 'PRICE_HISTORICAL_RATE', 0.005, 'Historical rate'], ['rate_trend', 'PRICE_RATE_TREND', 0.01, 'Rate trend'], ['daily_brief', 'PRICE_DAILY_BRIEF', 5.0, 'Daily brief'], ['transaction_cost', 'PRICE_TRANSACTION_COST', 0.01, 'Cross-border payment cost — FX spread + fees + settlement by method']]
